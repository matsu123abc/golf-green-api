...
<button id="toggle3d" style="width:90%; padding:10px; background:#333; color:white; border:none; border-radius:6px;">
  3D 表示を開く
</button>

<iframe id="view3d" src="/green/1/3d" style="display:none;"></iframe>
